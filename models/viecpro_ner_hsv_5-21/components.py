...
class RenameFunctions(object):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._lst_remove_str = lst_remove_str
        self._lst_remove_patterns = lst_remove_patterns
        nlp.get_pipe("ner").add_label("AMT")
        self._lst_amt = lst_amt
        self._df_aemter_index = df_aemter_index
        self._lst_hofstaat = lst_hofstaat
...
class RemoveNames(object):
    ...
    def __init__(
        self, nlp, lst_remove=["gewes.", "neu aufgenommener"], *args, **kwargs
    ):
