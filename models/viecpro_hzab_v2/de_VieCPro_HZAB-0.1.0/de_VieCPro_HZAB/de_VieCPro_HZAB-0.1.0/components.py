...
class RenameFunctions(object):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._lst_remove_str = kwargs.get("lst_remove_str", [
            "!!!!",
            "20 jähr.",
        ])
        self._lst_remove_patterns = kwargs.get("lst_remove_patterns", [
            "^[A-Z\-]+$",
            "^[a-z\-]+$",
            "^[0-9]{1,3}$",
            "[\[\]]+",
...
class DatePrepocissions(object):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._preproc = sorted(kwargs.get("preproc", ["ab", "bis", "bis mind.", "ab mind.", "?", "ab ?", "bis ?"]), key=len)
